...
void radix_16_dif(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
...
# ifndef NDEBUG1
  ...
  printf(" Radix_16_dif n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_16_dif_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                       y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i,
  t8r,t8i,t9r,t9i,t10r,t10i,t11r,t11i,t12r,t12i,t13r,t13i,t14r,t14i,t15r,
...
# ifndef NDEBUG1
  ...
  printf(" Radix_16_dif_notw n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_16_dit(y_ptr d, y_ptr tw, y_size_t n , y_size_t n0, y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i,
  t8r,t8i,t9r,t9i,t10r,t10i,t11r,t11i,t12r,t12i,t13r,t13i,t14r,t14i,t15r,
  t15i;
...
# ifndef NDEBUG1
  ...
  printf(" Radix_16_dit n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
#if !defined(Y_SAVE_TRIGS) || defined(Y_PRELOAD_TRIGS) || defined(Y_PRELOAD_DATA) || defined(Y_PREFETCH_EXPENSIVE)
...
# endif
  ...
  This optimization tries to use the trig factors load/or computed in a cycle
  in the following cycle (bigpad ahead).

  It is no aplicable when defined Y_PRELOAD_TRIGS, Y_PRELOAD_DATA
...
void radix_16_dit_notw(y_ptr d, y_ptr tw, y_size_t n , y_size_t n0,
                       y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i,
  t8r,t8i,t9r,t9i,t10r,t10i,t11r,t11i,t12r,t12i,t13r,t13i,t14r,t14i,t15r,
...
# ifndef NDEBUG1
  ...
  printf(" Radix_16_dit_notw n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_16_dif(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
  printf("Called radix_16_dif , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
...
void radix_16_dif_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                       y_size_t pad)
{
  printf("Called radix_16_dif_notwd , d=%p, tw=%p, n=%d, n=%d, pad=%d\n",d,tw,n,n0,pad);
  printf("Please compile again the file radix_16.c with -DY_AVAL=4 flag\n");
  exit(-1);
}
...
void radix_16_dit(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
  printf("Called radix_16_dit , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
  printf("Please compile again the file radix_16.c with -DY_AVAL=4 flag\n");
  exit(-1);
}
...
void radix_16_dit_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                       y_size_t pad)
{
  printf("Called radix_16_dit_notwd , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
  printf("Please compile again the file radix_16.c with -DY_AVAL=4 flag\n");
  exit(-1);
}
