...
#define init_twiddle_factors_9_t \
  t1r=1.0; t1i=0.0;            \
  t2r=1.0; t2i=0.0;            \
  t3r=1.0; t3i=0.0;            \
  t4r=1.0; t4i=0.0;            \
...
#define  load_two_to_minusphi_9(_i) \
	tt0[1] = two_to_minusphi[addr(_i)]; \
	tt1[1] = two_to_minusphi[addr(((pad2>>SHIFT_UPDATE) + _i))];\
	tt2[1] = two_to_minusphi[addr(((pad4>>SHIFT_UPDATE) + _i))];\
	tt3[1] = two_to_minusphi[addr(((pad6>>SHIFT_UPDATE) + _i))];\
...
#  define trig_9_load_init(_px)              \
          tpw1r = *(_px );                   \
          tpw1i = *(_px + 1);

#  define trig_9_preload(_px)                \
          tpw1r = *(_px + Y_STEP);           \
          tpw1i = *(_px + Y_STEP + 1);

#  define get_twiddle_factors_9_preload      \
...
#  define get_twiddle_factors_9_preload_consumed  \
          t1r = tpw1r; t1i = tpw1i;               \
          trig_9_preload(px);                     \
...
#  define get_twiddle_factors_9_preload         \
          cplx_complete_twiddle_9_ia64(tw,tpw); \
          trig_9_preload(px);                   \

#  define get_twiddle_factors_9_preload_consumed  \
          cplx_complete_twiddle_9_ia64(t,tpw);    \
          trig_9_preload(px);                     \
...
# define radix_9_twd_last_dit(_k)                                          \
    t0r = s0r; t0i = s0i; ppd0r = ppdl0r; ppd0i = ppdl0i;                  \
    ppdl0r +=_k; ppdl0i += _k; s0r= *(ppdl0r); s0i=*(ppdl0i);              \
    cplx_four_muls_fftn_preload_consumed_trigs_paired(t1,t3,t2,t6,1,3,2,6,s,t,ppd,ppdl,_k);\
    cplx_four_muls_fftn_preload_consumed_trigs_paired(t5,t7,t4,t8,5,7,8,4,s,t,ppd,ppdl,_k);\
    cplx_three_fft3_ia64_B(t0,t1,t2,t3,t4,t5,t6,t7,t8);                    \
                                                                           \
    cplx_four_divs(t4,t7,t5,t8,F_1_9,F_2_9,F_2_9,F_4_9);                   \
    cplx_three_fft3_ia64_B(t0,t3,t6,t1,t4,t7,t2,t5,t8);

# define radix_9_first_dif(_j)                                             \
    cplx_three_fft3_ia64_F(t0,t3,t6,t1,t4,t7,t2,t5,t8);                    \
    cplx_four_muls(t4,t5,t7,t8,F_1_9,F_2_9,F_2_9,F_4_9);                   \
    cplx_three_fft3_first_dif_9_store_F(t0,t1,t2,t3,t4,t5,t6,t7,t8,ppd0,ppd3,ppd6,ppd1,ppd4,ppd7,ppd2,ppd5,ppd8);


#elif defined(Y_LONG_MACROS)
# define radix_9_twd_last_dit(_j)                          \
	  cplx_data_to_local_pp(t0,_j,pd0);                \
	  cplx_load_mulmul_pp(t3,t6,tw1,tw2,_j,pd1,pd2);   \
	  ...
	  cplx_three_fft3(B,t0,t1,t2,t3,t4,t5,t6,t7,t8);   \
	                                                   \
	  cplx_divdiv(t4,t7, F_1_9, F_2_9);                \
	  cplx_divdiv(t5,t8, F_2_9, F_4_9);                \
	  cplx_three_fft3(B,t0,t3,t6,t1,t4,t7,t2,t5,t8);


# define radix_9_first_dif(_j)                             \
	  cplx_three_fft3(F,t0,t3,t6,t1,t4,t7,t2,t5,t8);   \
	  cplx_fft3_store_p(_j,pd0,pd3,pd6,F,t0,t1,t2);    \
	  cplx_mulmul(t4,t5, F_1_9, F_2_9);                \
	  cplx_mulmul(t7,t8, F_2_9, F_4_9);                \
          cplx_two_fft3_store_p_F(_j,pd1,pd4,pd7,pd2,pd5,pd8,t3,t4,t5,t6,t7,t8);
...
# define radix_9_twd_last_dit(_j) \
	  ...
	  cplx_fft3(B,t6,t7,t8);\
	   \
	  cplx_fft3(B,t0,t3,t6);\
	  cplx_divdiv(t4,t7, F_1_9, F_2_9);\
	  cplx_fft3(B,t1,t4,t7);\
	  cplx_divdiv(t5,t8, F_2_9, F_4_9);\
	  cplx_fft3(B,t2,t5,t8);


# define radix_9_first_dif(_j) \
	  cplx_fft3(F,t0,t3,t6);\
	  cplx_fft3(F,t1,t4,t7);\
	  cplx_fft3(F,t2,t5,t8);\
	  cplx_fft3_store_p(_j,pd0,pd3,pd6,F,t0,t1,t2);\
	  cplx_mulmul(t4,t5, F_1_9, F_2_9);\
	  cplx_fft3_store_p(_j,pd1,pd4,pd7,F,t3,t4,t5);\
	  cplx_mulmul(t7,t8, F_2_9, F_4_9);\
	  cplx_fft3_store_p(_j,pd2,pd5,pd8,F,t6,t7,t8);


#endif

#define radix_9_first_dif_add( _d )           \
	  cplx_fft3(F,t0,t3,t6);              \
	  cplx_fft3(F,t1,t4,t7);              \
	  cplx_fft3(F,t2,t5,t8);              \
	  cplx_fft3(F,t0,t1,t2);              \
	  cplx_local_to_data_add(_d, 0 , t0); \
	  cplx_local_to_data_add(_d, pad3,t1);\
	  cplx_local_to_data_add(_d, pad6,t2);\
	  cplx_mulmul(t4,t5, F_1_9, F_2_9);   \
	  cplx_fft3(F,t3,t4,t5);              \
	  cplx_local_to_data_add(_d, pad,t3); \
	  cplx_local_to_data_add(_d, pad4,t4);\
	  cplx_local_to_data_add(_d, pad7,t5);\
	  cplx_mulmul(t7,t8, F_2_9, F_4_9);   \
	  cplx_fft3(F,t6,t7,t8);              \
	  cplx_local_to_data_add(_d,pad2,t6); \
	  cplx_local_to_data_add(_d,pad5,t7); \
	  cplx_local_to_data_add(_d,pad8,t8);

#define radix_9_first_dif_add_shift(_d, _ofs) \
	  cplx_fft3(F,t0,t3,t6);              \
	  cplx_fft3(F,t1,t4,t7);              \
	  cplx_fft3(F,t2,t5,t8);              \
	  cplx_fft3(F,t0,t1,t2);              \
...
void substract_two_9(BIG_DOUBLE *x, UL N)
{
  double t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,
  t5r,t5i,t6r,t6i,t7r,t7i,t8r,t8i,xtwo;
  UL pad=Y_LRIGHT[1],pad2,pad3,pad4,pad5,pad6,pad7,pad8,ofs,ni,who,ib,a;
  ...
  who=(ni*Y_PLAN[0])/N;
  /* The shifted value of minus two */
  ...
  radix_9_first_dif_add_shift(x,ofs);
...
void dit_carry_norm_dif_9(BIG_DOUBLE *x,UL N, UL err_flag )
{
# ifdef Y_KILL_BRANCHES
...
# else
  ...
  BIG_DOUBLE ttp0,ttp1,ttp2,ttp3,ttp4,ttp5,ttp6,ttp7,ttp8;
# endif
# ifdef Y_ITANIUM
...
# endif
  ...
  BIG_DOUBLE carry0=0.0,carry1=0.0,carry2=0.0,carry3=0.0,
                                          carry4=0.0,carry5=0.0,carry6=0.0,carry7=0.0,carry8=0.0;
# ifndef Y_PRELOAD_DATA
...
#  ifndef Y_MINIMUM
  ...
  BIG_DOUBLE tpw2r,tpw2i,tpw6r,tpw6i;
#  endif
# endif
...
# ifdef Y_PRELOAD_DATA
  ...
  ppd5r,ppd5i,ppd6r,ppd6i,ppd7r,ppd7i,ppd8r,ppd8i;
  y_ptr ppdl0r,ppdl0i,ppdl1r,ppdl1i,ppdl2r,ppdl2i,ppdl3r,ppdl3i,ppdl4r,ppdl4i,
  ppdl5r,ppdl5i,ppdl6r,ppdl6i,ppdl7r,ppdl7i,ppdl8r,ppdl8i;
# endif
...
# ifdef Y_PRELOAD_DATA
  ...
  init_twiddle_factors_9_t;
# else

  init_twiddle_factors_9;
# endif
...
# ifdef Y_ITANIUM
  ...
  cplx_radix_9_dif_dit_init(s,pd,ppdl)
# endif
  for (i=0,j=0; j<pad2; j+=UPDATE,i++)
    {
      load_dwf_9 (i);
      /*load_two_to_minusphi_9(i);
      load_two_to_phi_9(i);*/
...
# if defined(Y_ITANIUM)
              ...
              cplx_carry_norm_check_vector_3_ia64(t,r,6,7,8);
              if(l == (pad-1))
                bj8 = 0;
              cplx_carry_norm_check_vector_3_ia64(t,i,6,7,8);
# else
...
#  endif
              ...
              cplx_carry_norm_last_check(t,8);
# endif
...
# ifdef Y_ITANIUM
              ...
              cplx_carry_norm_vector_4_ia64(t,r,5,6,7,8);
              if(l == (pad-1))
                bj8 = 0;
              cplx_carry_norm_vector_4_ia64(t,i,5,6,7,8);
# else
#  ifdef Y_VECTORIZE
...
#  endif
              ...
              cplx_carry_norm_last(t,8);
# endif

            }

          radix_9_first_dif( ll );
...
#  ifdef Y_PRELOAD_DATA
          ...
          get_twiddle_factors_9_preload_consumed;
#  else

          get_twiddle_factors_9_preload;
#  endif
# else
...
# if defined(Y_MINIMUM)
#  define init_twiddle_factors_9_mp(_px)  \
...
#  define init_twiddle_factors_9_t_mp(_px) \
  t1r=_px[0]; t1i=_px[1];                  \
  cplx_trig_min_square(t2,t1);             \
  cplx_trig_min_square(t4,t2);             \
  cplx_divmul(t3,t5,t4,t1);                \
...
#  define init_twiddle_factors_9_mp_t(_px)  \
         t1r= _px[0];	 t1i= _px[1];    \
         t2r= _px[2];	 t2i= _px[3];    \
	 t3r= _px[4];    t3i= _px[5];    \
         t4r= _px[6];	 t4i= _px[7];    \
...
#  define init_twiddle_factors_9_t_mp(_px) \
   ...
   t2r= _px[2]; t2i= _px[3];               \
   t6r= _px[4]; t6i= _px[5];               \
   cplx_divmul(t4,t8,t6,t2);               \
   cplx_divmul(t5,t7,t6,t1);               \
   t3r= (t2r * t1r) - (t2i * t1i);         \
   t3i= (t2r * t1i) + (t2i * t1r);         \
   prefetch_data_trig(_px,6);              \
   prefetch_data_trig(_px,6 + Y_CACHE_LINE);
...
#define radix_9_first_dif_add_mp \
	  cplx_fft3(F,t0,t3,t6);\
	  cplx_fft3(F,t1,t4,t7);\
	  cplx_fft3(F,t2,t5,t8);\
	  cplx_fft3(F,t0,t1,t2);\
	  ...
	  cplx_local_to_data_add(pd6, 0,t2);\
	  cplx_mulmul(t4,t5, F_1_9, F_2_9);\
	  cplx_fft3(F,t3,t4,t5);\
	  cplx_local_to_data_add(pd1, 0,t3);\
	  cplx_local_to_data_add(pd4, 0,t4);\
	  cplx_local_to_data_add(pd7, 0,t5);\
	  cplx_mulmul(t7,t8, F_2_9, F_4_9);\
	  cplx_fft3(F,t6,t7,t8);\
	  cplx_local_to_data_add(pd2, 0,t6);\
	  cplx_local_to_data_add(pd5, 0,t7);\
	  cplx_local_to_data_add(pd8, 0,t8);

BIG_DOUBLE dit_carry_norm_dif_9_mp(BIG_DOUBLE *x,BIG_DOUBLE *ptx, BIG_DOUBLE *pcarr, UL *bp, UL N ,UL n0, UL nthr,UL err_flag)
{
# ifdef Y_KILL_BRANCHES
  double Y_ALIGNED(16) aux[6],maxerr=0.0;
  double Y_ALIGNED(16) tt0[2],tt1[2],tt2[2],tt3[2],tt4[2],tt5[2],tt6[2],tt7[2],tt8[2];
...
# endif
  ...
  UL pad = Y_LRIGHT[1], pad2, pad3, pad4, pad5, pad6, pad7, pad8, lim;
  UL i,j,k,l,ll,ofs;
# ifdef Y_KILL_BRANCHES
...
# ifdef Y_PRELOAD_DATA
      ...
      get_pads_9_mp(ofs);
      init_twiddle_factors_9_t_mp(ptx);
# else

get_pads_9;
init_twiddle_factors_9_mp(ptx);
# endif
...
void dit_carry_norm_dif_9_last_carries_mp(BIG_DOUBLE *x, UL *bp, UL N ,UL n0, int nthr)
{
# ifdef Y_KILL_BRANCHES
...
# endif
  ...
  for(i=0;i<Y_NTHREADS;i++)
    {
      Y_ERRS[i]=dit_carry_norm_dif_9_mp( x, Y_TWX[i], Y_CARRIES[i], Y_BJS[i],
                                         N, n0, i, err_flag);
    }
...
# endif
  for(i=0;i<Y_NTHREADS;i++)
    {
      dit_carry_norm_dif_9_last_carries_mp( x, Y_BJS[i],
                                            N, n0, i);
    }
