...
*************************************************************************/
void radix_8_dif(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
...
# endif
  ...
  printf(" Radix_8_dif n=%i n0=%i pad=%i \n",n,n0,pad);
#endif

#ifdef Y_PRELOAD_DATA

  get_pads_8_preload(n0);
#else
...
void radix_8_dit(y_ptr d, y_ptr tw, y_size_t n , y_size_t n0,y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i;
#ifdef Y_PRELOAD_DATA
...
# endif
  ...
  printf(" Radix_8_dit n=%i n0=%i pad=%i \n",n,n0,pad);
#endif
#ifdef Y_PRELOAD_DATA
...
void radix_8_dit_notw(y_ptr d, y_ptr tw, y_size_t n , y_size_t n0,
                      y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i;
#ifdef Y_PRELOAD_DATA
  ...
  printf(" Radix_8_dit_notw n=%i n0=%i pad=%i \n",n,n0,pad);
#endif
...
#ifdef Y_ITANIUM
      j=addr(i<<1);
      cplx_radix_8_load_all(s,j,pd,ppdl);
#endif
#ifdef Y_PRELOAD_DATA

      kk= addr(i<<1);
      radix_8_init_preload(tp,pd,kk);
#endif
...
void radix_8_dif_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                      y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i;
#ifdef Y_PRELOAD_DATA
  ...
  printf(" Radix_8_dif_notw n=%i n0=%i pad=%i \n",n,n0,pad);
#endif
      ...
      for(j=i;j<(pad+i);j++)
        {
          ...
          jj=addr((j+1)<<1);
          radix_8_notwd_pp(F,jj);
#elif defined(Y_PRELOAD_DATA)

          jj=addr((j+1)<<1);
          radix_8_notwd_preload(F,kk,jj);
#else
