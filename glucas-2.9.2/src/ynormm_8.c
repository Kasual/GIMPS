...
# define init_twiddle_factors_sse2_8( _pd )      \
...
#define radixmm_8_first_dif(_j)                      \
   ...
   sse2_addsub(t3, t7);                              \
   sse2_addsub(t1, t3);                              \
   sse2_mul_1_4_F_addsub(t5, t7);                    \
   sse2_addsub_store_inter_p(_j,pd0,pd4,t0,t1);            \
   sse2_mul_1_8_F_addsub_store_inter_p(_j,pd1,pd5,t4,t5);  \
   sse2_mul_1_4_F_addsub_store_inter_p(_j,pd2,pd6,t2,t3);  \
   sse2_mul_3_8_F_addsub_store_inter_p(_j,pd3,pd7,t6,t7);


#define radixmm_8_first_dif_add(_d)          \
   Y_MM_MOV_INTER_PAIR(t0r, t4r);            \
   Y_MM_MOV_INTER_PAIR(t0i, t4i);            \
   sse2_addsub(t0, t4);                      \
   Y_MM_MOV_INTER_PAIR(t2r, t6r);            \
   ...
   sse2_local_to_data_inter_add(_d, pad4, t1);     \
   sse2_mul_1_8_F_addsub(t4, t5);            \
   sse2_local_to_data_inter_add(_d, pad, t4);      \
   sse2_local_to_data_inter_add(_d, pad5, t5);     \
   sse2_mul_1_4_F_addsub(t2, t3);            \
   sse2_local_to_data_inter_add(_d, pad2, t2);     \
   sse2_local_to_data_inter_add(_d, pad6, t3);     \
   sse2_mul_3_8_F_addsub(t6, t7);            \
   sse2_local_to_data_inter_add(_d, pad3, t6);     \
   sse2_local_to_data_inter_add(_d, pad7, t7);


#define radixmm_8_first_dif_add_shift(_d,_ofs) \
	sse2_addsub(t0, t4);                  \
	sse2_addsub(t2, t6);                  \
	sse2_addsub(t0, t2);                  \
	sse2_mul_1_4_F_addsub(t4, t6);        \
...
#define radixmm_8_first_dif(_j)                      \
   ...
   sse2_addsub(t1, t3);                              \
   sse2_mul_1_4_F_addsub(t5, t7);                    \
   sse2_addsub_store_p(_j,pd0,pd4,t0,t1);            \
   sse2_mul_1_8_F_addsub_store_p(_j,pd1,pd5,t4,t5);  \
   sse2_mul_1_4_F_addsub_store_p(_j,pd2,pd6,t2,t3);  \
   sse2_mul_3_8_F_addsub_store_p(_j,pd3,pd7,t6,t7);
...
#define radixmm_8_first_dif_add(_d)          \
   ...
   sse2_local_to_data_add(_d, pad4, t1);     \
   sse2_mul_1_8_F_addsub(t4, t5);            \
   sse2_local_to_data_add(_d, pad, t4);      \
   sse2_local_to_data_add(_d, pad5, t5);     \
   sse2_mul_1_4_F_addsub(t2, t3);            \
   sse2_local_to_data_add(_d, pad2, t2);     \
   sse2_local_to_data_add(_d, pad6, t3);     \
   sse2_mul_3_8_F_addsub(t6, t7);            \
   sse2_local_to_data_add(_d, pad3, t6);     \
   sse2_local_to_data_add(_d, pad7, t7);
...
void substract_two_8_sse2(y_ptr x, UL N)
{
  ...
  */
  ...
  radixmm_8_first_dif_add_shift ( x, ofs);
...
void dit_carry_norm_dif_8_sse2(y_ptr x, UL N ,UL err_flag)
{
  Y__M128D ttp04, ttp15, ttp26, ttp37, ttmp04, ttmp15, ttmp26, ttmp37;
  Y__M128D tw1r, tw1i, tw2r, tw2i, tw3r, tw3i, tw4r, tw4i, tw5r, tw5i,
  tw6r, tw6i, tw7r, tw7i;
  Y__M128D t0r, t0i, t1r, t1i, t2r, t2i, t3r, t3i, t4r, t4i, t5r, t5i,
  t6r, t6i, t7r, t7i;
  Y__M128D bj04, bj15, bj26, bj37;
  Y__M128D carry04, carry15, carry26, carry37, maxerr;
#if defined(SUM_CHECK)
  ...
  y_ptr px, pd0, pd1, pd2, pd3, pd4, pd5, pd6, pd7;
  ...
  init_twiddle_factors_sse2_8(px);
          ...
          if(err_flag)
            {
              ...
              cplx_carry_norm_check_sse2_last(t7i, 37);
#else
          ...
          else
            {
              ...
              cplx_carry_norm_sse2_last(t7i, 37);
#else
  ...
  Y_MM_SWAP_PD( carry37);

  Y_MM_MOV_PD( t0r, carry37);
...
#  define init_twiddle_factors_sse2_8_mp(_px)              \
...
#  define init_twiddle_factors_sse2_8_mp(_px)                  \
   ...
   Y_MM_LOAD_INTER_PAIR(tw5r, tw5i, _px + 4, _px + Y_STEP + 4);\
   sse2_divmul(tw3, tw7, tw5, tw2);                            \
   sse2_divmul(tw4, tw6, tw5, tw1);                            \
...
# define radixmm_8_first_dif_add_mp          \
   Y_MM_MOV_INTER_PAIR(t0r, t4r);            \
   Y_MM_MOV_INTER_PAIR(t0i, t4i);            \
   sse2_addsub(t0, t4);                      \
   Y_MM_MOV_INTER_PAIR(t2r, t6r);            \
   ...
   sse2_local_to_data_inter_add(pd4, 0, t1); \
   sse2_mul_1_8_F_addsub(t4, t5);            \
   sse2_local_to_data_inter_add(pd1, 0, t4); \
   sse2_local_to_data_inter_add(pd5, 0, t5); \
   sse2_mul_1_4_F_addsub(t2, t3);            \
   sse2_local_to_data_inter_add(pd2, 0, t2); \
   sse2_local_to_data_inter_add(pd6, 0, t3); \
   sse2_mul_3_8_F_addsub(t6, t7);            \
   sse2_local_to_data_inter_add(pd3, 0, t6); \
   sse2_local_to_data_inter_add(pd7, 0, t7);
...
# define radixmm_8_first_dif_add_mp          \
   ...
   sse2_local_to_data_add(pd4, 0, t1);       \
   sse2_mul_1_8_F_addsub(t4, t5);            \
   sse2_local_to_data_add(pd1, 0, t4);       \
   sse2_local_to_data_add(pd5, 0, t5);       \
   sse2_mul_1_4_F_addsub(t2, t3);            \
   sse2_local_to_data_add(pd2, 0, t2);       \
   sse2_local_to_data_add(pd6, 0, t3);       \
   sse2_mul_3_8_F_addsub(t6, t7);            \
   sse2_local_to_data_add(pd3, 0, t6);       \
   sse2_local_to_data_add(pd7, 0, t7);

# endif

BIG_DOUBLE dit_carry_norm_dif_8_mp_sse2(y_ptr x, y_ptr ptx, y_ptr pcarr,
                                        y_ptr bp, UL N ,UL n0, UL nthr, UL err_flag)
{
  ...
  Y__M128D bj04, bj15, bj26, bj37;
  Y__M128D carry04, carry15, carry26, carry37, maxerr ;
  y_ptr pd0, pd1, pd2, pd3, pd4, pd5, pd6, pd7, px;
  UL pad = Y_LRIGHT[1], pad2, pad3, pad4, pad5, pad6, pad7;
  ...
  if(nthr)
    {
      ...
      */
      init_twiddle_factors_sse2_8_mp (ptx);
      px = ptx + 2 * Y_STEP;
    }
  else
    {
      ...
      */
      if(Y_SBIT == 0)
        Y_MM_SET_PD(carry04, -2.0, 0.0);
      init_twiddle_factors_sse2_8 (ptx);
      px = ptx + Y_STEP;
    }
...
# ifdef SUM_CHECK
          ...
          sse2_sum_8 (Y_SUMOUT[nthr]);
# endif

          /*if( (k + j + 4 ) < lim ) get_twiddle_factors_sse2_8;*/
          if(err_flag)
            {
...
void dit_carry_norm_dif_8_last_carries_mp_sse2 (y_ptr x, y_ptr bp, UL N ,UL n0, int nthr)
{
  Y__M128D ttp04, ttp15, ttp26, ttp37, ttmp04, ttmp15, ttmp26, ttmp37;
  Y__M128D t0r, t0i, t1r, t1i, t2r, t2i, t3r, t3i, t4r, t4i, t5r, t5i,
  t6r, t6i, t7r, t7i;
  Y__M128D bj04, bj15, bj26, bj37;
  Y__M128D carry04, carry15, carry26, carry37;
  ...
  if(nthr)
    ...
    {
      Y_MM_LOAD_PD( t0r, Y_CARRIES[Y_NTHREADS - 1] + 6);
...
void dit_carry_norm_dif_8_sse2(BIG_DOUBLE *x, UL N ,UL err_flag)
{
  int i, n0;
...
# endif
  ...
  for(i = 0;i < Y_NTHREADS; i++)
    {
      Y_ERRS[i] = dit_carry_norm_dif_8_mp_sse2 ( x, Y_TWX[i], Y_CARRIES[i], Y_XBJS[i],
                  N, n0, i, err_flag);
    }
...
# endif
  for(i = 0; i < Y_NTHREADS; i++)
    {
      dit_carry_norm_dif_8_last_carries_mp_sse2( x, Y_XBJS[i],
          N, n0, i);
    }
...
{
  printf("The routine void_carry_norm_8_sse2 should never be called\n");
  exit(EXIT_FAILURE);
}
