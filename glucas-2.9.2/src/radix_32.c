...
void radix_32_dif(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
...
# ifndef NDEBUG1
  ...
  printf(" Radix_32_dif n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_32_dif_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                       y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i,
  t8r,t8i,t9r,t9i,t10r,t10i,t11r,t11i,t12r,t12i,t13r,t13i,t14r,t14i,t15r,
...
# ifndef NDEBUG1
  ...
  printf(" Radix_32_dif_notw n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_32_dit(y_ptr d, y_ptr tw, y_size_t n , y_size_t n0, y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i,
  t8r,t8i,t9r,t9i,t10r,t10i,t11r,t11i,t12r,t12i,t13r,t13i,t14r,t14i,t15r,
  t15i,t16r,t16i,t17r,t17i,t18r,t18i,t19r,t19i,t20r,t20i,t21r,t21i,t22r,
...
# ifndef NDEBUG1
  ...
  printf(" Radix_32_dit n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_32_dit_notw(y_ptr d, y_ptr tw, y_size_t n , y_size_t n0,
                       y_size_t pad)
{
  y_limb_t t0r,t0i,t1r,t1i,t2r,t2i,t3r,t3i,t4r,t4i,t5r,t5i,t6r,t6i,t7r,t7i,
  t8r,t8i,t9r,t9i,t10r,t10i,t11r,t11i,t12r,t12i,t13r,t13i,t14r,t14i,t15r,
...
# ifndef NDEBUG1
  ...
  printf(" Radix_32_dit_notw n=%i n0=%i pad=%i \n",n,n0,pad);
# endif
...
void radix_32_dif(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
  printf("Called radix_32_dif , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
...
void radix_32_dif_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                       y_size_t pad)
{
  printf("Called radix_32_dif_notwd , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
  printf("Please compile again the file radix_32.c with -DY_AVAL=5 flag\n");
  exit(-1);
}
...
void radix_32_dit(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0, y_size_t pad)
{
  printf("Called radix_32_dit , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
  printf("Please compile again the file radix_32.c with -DY_AVAL=5 flag\n");
  exit(-1);
}
...
void radix_32_dit_notw(y_ptr d, y_ptr tw, y_size_t n, y_size_t n0,
                       y_size_t pad)
{
  printf("Called radix_32_dit_notwd , d=%p, tw=%p, n=%d, n0=%d, pad=%d\n",d,tw,n,n0,pad);
  printf("Please compile again the file radix_32.c with -DY_AVAL=5 flag\n");
  exit(-1);
}
